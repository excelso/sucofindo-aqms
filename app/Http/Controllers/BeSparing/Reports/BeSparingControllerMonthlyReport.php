<?php
    ...
    use App\Http\Controllers\MonthCalculator;
    ...
    class BeSparingControllerMonthlyReport extends Controller {
        protected string $viewPath;

        public function __construct() {
            $this->viewPath = 'main.be-sparing.reports.monthly-report';
        }
        ...
        public function handleDataAvgParameterWeekly(Request $request): JsonResponse {
            try {
        ...
        public function handleDataEntryCharts(Request $request) {
            try {
                ...
                $weekCalculator = new MonthCalculator();
                $weekGroups = $weekCalculator->getMonthGroupings($request->input('year'), $request->input('month'));
                ...
                foreach ($weekGroups as $i => $week) {
                    ...
                    foreach ($dataSensor as $item) {
                        ...
                        $data[] = [
                            ...
                            'x' => Carbon::createFromTimestamp($item->datetime_unix_interval)->getPreciseTimestamp(3),
                            'y' => $param
                        ];
                    }
