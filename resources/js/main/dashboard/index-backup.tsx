...
document.addEventListener('DOMContentLoaded', function () {
    ...
    //region Handle Gauge Function Helper
    ...
    //region Handle Chart PM10
    function handleChartPm10() {
        ...
        chartP10.forEach((elm) => {
            Highcharts.chart({
                ...
                series: [{
                    name: 'PM10',
                    type: 'gauge',
                    data: [Math.floor(Math.random() * (75.5 - 20.5) + 20.5)],
                    dial: {
                        radius: '0%',
                    ...
                    dataLabels: {
                        formatter: function () {
                            ...
                            return `
                                ...
                                <div class="font-normal text-[10px] leading-[2px] mb-2">µg/m³</div>
                            `;
                        },
                        borderWidth: 0,
                        color: '#333',
                ...
                console.log('PM10 Oke');

                setInterval(() => {
                    const series = chart.series[0];
                    const value = (Math.random() * (75.5 - 20.5) + 20.5);
    ...
    //region Handle Chart PM2.5
    function handleChartPm25() {
        const stops: [number, string][] = [
            [0, '#4CAF50'],
            [0.2, '#8BC34A'],
            [0.4, '#FFC107'],
    ...
    //region Handle Chart PM1.0
    function handleChartPm1() {
        const stops: [number, string][] = [
            [0, '#4CAF50'],
            [0.2, '#8BC34A'],
            [0.4, '#FFC107'],
    ...
    //region Handle Chart Noise
    function handleChartNoise() {
        const stops: [number, string][] = [
            [0, '#4CAF50'],
            [0.2, '#8BC34A'],
            [0.4, '#FFC107'],
                ...
                series: [{
                    ...
                    dataLabels: {
                        formatter: function () {
                            ...
                            return `
                                <div class="font-bold text-[14px] leading-[2px]">${format.format(this.y)}</div><br>
                                <div class="font-normal text-[10px] leading-[2px] mb-2">db</div>
                            `;
                        },
                        borderWidth: 0,
                        color: '#333',
