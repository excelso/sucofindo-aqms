                             ...
                             <div class="flex items-center">
                                 ...
                                 <div class="flex justify-end">
                                     <a class="cursor-pointer">
                                         <img src="{{ asset('images/vector/icons8-cctv-100.png') }}" width="24" alt="cctv">
                                     </a>
                                 </div>
                             </div>
                             <div class="mt-4">
                                 <div class="grid grid-cols-4 gap-2">
                                     <div class="border rounded-md">
                                         <div class="font-bold text-[12px] m-2 mb-2">PM10</div>
                                         <div class="chart-p10"></div>
                                     </div>
                                     <div class="border rounded-md">
                                         <div class="font-bold text-[12px] m-2 mb-2">PM2.5</div>
                                         <div class="chart-p25"></div>
                                     </div>
                                     <div class="border rounded-md">
                                         <div class="font-bold text-[12px] m-2 mb-2">PM1.0</div>
                                         <div class="chart-p1"></div>
                                     </div>

                                     <div class="border rounded-md">
                                         <div class="font-bold text-[12px] m-2 mb-2">Noise</div>
                                         <div class="chart-noise"></div>
                                     </div>
                                 </div>
                             </div>
...
@vite(['resources/js/main/dashboard/index-backup.tsx'])
