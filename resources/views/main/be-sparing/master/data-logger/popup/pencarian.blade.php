    ...
    <div class="modal-main">
        ...
        <div class="modal-body overflow-y-auto !max-h-[400px]">
            ...
            <div class="form-group">
                ...
                <div class="form-group-control">
                    <select name="customer_lokasi_id" class="form-select select2-custom lookCustomerLokasiId" data-selected="{{ request()->input('customer_lokasi_id') }}">
                        <option value="">...</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="form-group-control">
                    <select name="site_id" class="form-select select2-custom lookSiteId" data-selected="{{ request()->input('site_id') }}">
                        <option value="">...</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="form-group-control">
                    <select class="form-control select2-custom" name="tipe_logger">
            ...
            <div class="form-group">
                ...
                <label class="form-group-control">
                    <input name="uid" class="form-control" value="{{ request()->input('uid') ?? '' }}" placeholder="..."/>
                </label>
            </div>
            <div class="form-group">
                <label>Jenis Industri</label>
                <div class="form-group-control">
                    <select name="jenis_industri" class="form-select select2-custom">
                        <option value="">...</option>
                        @if(isset($jenisIndustri))
                            @foreach($jenisIndustri as $item)
                                @php($selected = $item->id == request()->input('jenis_industri') ? 'selected' : '')
                                <option value="{{ $item->id }}" {{ $selected }}>{{ $item->jenis_industri }}</option>
                            @endforeach
                        @endif
                    </select>
                </div>
