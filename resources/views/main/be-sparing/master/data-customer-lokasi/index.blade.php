@section('title', 'Data Site / Lokasi')
<x-app-layout>
    <div class="content-main">
            ...
            <div class="flex flex-row items-center">
                ...
                <div class="mr-2">
                    <a class="btn btn-primary btnTambah ml-2">
                        <i class="fas fa-plus-circle mr-2"></i> Tambah Site / Lokasi
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="content-body">
            <div class="card z-[200]">
                ...
                <div class="card-body w-full !p-0">
                        ...
                        <table class="table table-fixed">
                            <thead>
                                <tr class="sticky-header">
                                    ...
                                    <th class="text-left w-[150px]">Nama Site / Lokasi</th>
                                    <th class="text-left w-[150px]">Nama Perusahaan</th>
                                ...
                                @if(isset($items) && count($items) !== 0)
                                    @foreach($items as $item)
                                        <tr class="data-tables" data-items="{{json_encode($item)}}">
                                            ...
                                            <td class="text-left">{{ $item->nama_lokasi }}</td>
                    ...
                    @if(isset($items) && count($items) === 0)
                        <div class="not-found">
                            <div>Data Lokasi tidak ditemukan</div>
                        </div>
                    @endif
                </div>
        ...
        @include('main.be-sparing.master.data-customer-lokasi.popup.pencarian')
        @include('main.be-sparing.master.data-customer-lokasi.popup.form')

    </div>
</x-app-layout>

@vite(['resources/js/main/be-sparing/master/data-customer-lokasi/index.tsx'])
