...
<x-app-layout>
    <div class="content-main">
            ...
            <div class="flex flex-row items-center">
                ...
                <div class="mr-2">
                    <a class="btn btn-primary btnTambah ml-2">
                        <i class="fas fa-plus-circle mr-2"></i> Tambah WMP
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-fixed">
                            <thead>
                                <tr class="sticky-header">
                                    ...
                                    <th class="text-left w-[150px]">Nama WMP</th>
                                ...
                                @if(isset($items) && count($items) !== 0)
                                    @foreach($items as $item)
                                        <tr class="data-tables" data-items="{{json_encode($item)}}">
                                            ...
                                            <td class="text-left">{{ $item->nama_site }}</td>
        ...
        @include('main.be-sparing.master.data-site.popup.pencarian')
        @include('main.be-sparing.master.data-site.popup.form')

    </div>
</x-app-layout>

@vite(['resources/js/main/be-sparing/master/data-site/index.tsx'])
